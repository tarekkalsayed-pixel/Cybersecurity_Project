...
# Only these columns are allowed to be updated. Prevents SQL injection via column names.
_UPDATABLE_COLUMNS = {"status", "action_taken", "evidence_path", "recovery_status"}
...
class IncidentLogger:
    ...
    def update_incident(self, incident_id: int, **fields) -> None:
        ...
        if invalid:
            raise ValueError(f"Refusing to update unknown column(s): {invalid}")
